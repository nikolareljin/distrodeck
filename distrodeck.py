...
def git_status_shell_script() -> str:
    return "\n".join(
        [
            ...
            "  local branch upstream counts ahead behind status status_text",
            ...
            "      PROMPT=\"${DISTRODECK_GIT_STATUS_ORIG_PROMPT/%#/%# \\$(distrodeck_git_status)}\"",
            "    else",
            "      PROMPT=\"${DISTRODECK_GIT_STATUS_ORIG_PROMPT} \\$(distrodeck_git_status)\"",
            "    fi",
            "  else",
            ...
            "      PS1=\"${DISTRODECK_GIT_STATUS_ORIG_PS1/\\\\$ /\\\\$(distrodeck_git_status)\\\\$ }\"",
...
def git_status_fish_script() -> str:
    return "\n".join(
        [
            ...
            "      set status_text \" $ahead↑$behind↓\"",
            "    else if test \"$behind\" != \"0\"",
            "      set status_text \" $behind↓\"",
            "    else if test \"$ahead\" != \"0\"",
            "      set status_text \" $ahead↑\"",
            "    else",
            "      set status_text \" ≡\"",
            "    end",
            "  end",
